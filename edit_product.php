...
<?php
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
       ...
       $query  .=" buy_price ='{$p_buy}', sale_price ='{$p_sale}', categorie_id ='{$p_cat}',media_id='{$media_id}',exp_date='{$p_expd}'";
              ...
              <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="product-title" placeholder="Product Title" maxlength="40" value="<?php echo remove_junk($product['name']);?>">
                      </div>
                    </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <input class="form-control" type="date" name="exp-date" value="<?php echo remove_junk($product['exp_date']); ?>">
                  </div>
                </div>
