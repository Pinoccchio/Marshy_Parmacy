  ...
  if(isset($_POST['p_name']) && strlen($_POST['p_name']))
  {
    ...
    if($results = find_all_product_info_by_title($product_title)){
        foreach ($results as $result) {
          ...
          $html  .= "<td>";
          $html  .= "<input type=\"number\" class=\"form-control\" name=\"price\" step=\"0.05\" value=\"{$result['sale_price']}\">";
          $html  .= "</td>";
          $html .= "<td id=\"s_qty\">";
          $html .= "<input type=\"number\" class=\"form-control\" name=\"quantity\" value=\"1\">";
          $html  .= "</td>";
          $html  .= "<td>";
          $html  .= "<input type=\"number\" class=\"form-control\" name=\"total\" value=\"{$result['sale_price']}\">";
          $html  .= "</td>";
          $html  .= "<td>";
