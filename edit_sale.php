          ...
          <th> Action</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                <td id="s_name">
                  <input type="text" class="form-control" id="sug_input" name="title" maxlength="40" value="<?php echo remove_junk($product['name']); ?>">
                ...
                <td id="s_price">
                  <input type="number" class="form-control" name="price" step="0.05" value="<?php echo remove_junk($product['sale_price']); ?>" >
                </td>
                <td>
                  <input type="number" class="form-control" name="total" value="<?php echo remove_junk($sale['price']); ?>">
                </td>
                <td id="s_date">
